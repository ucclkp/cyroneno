...
namespace cyro {
    ...
    {
        Line2DEqu line01(static_cast<Point2>(p0), static_cast<Point2>(p1));
        Line2DEqu line02(static_cast<Point2>(p0), static_cast<Point2>(p2));
        Line2DEqu line12(static_cast<Point2>(p1), static_cast<Point2>(p2));
