...
#ifndef CYRONENO_TEST_UI_RAY_TRACER_RT_LIGHT_LIST_SOURCE_H_
#define CYRONENO_TEST_UI_RAY_TRACER_RT_LIGHT_LIST_SOURCE_H_
...
namespace cyro {
    ...
    class RTLightListSource : public ukive::ListSource {
    public:
        class RTLightItem : public ukive::ListItem {
        public:
            explicit RTLightItem(ukive::View* v)
                : ListItem(v) {}
...
#endif  // CYRONENO_TEST_UI_RAY_TRACER_RT_LIGHT_LIST_SOURCE_H_